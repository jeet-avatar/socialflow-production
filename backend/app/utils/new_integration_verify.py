...
def main():
    ...
    print(" SMTP Verification Result:")
    print("=" * 50)
    print(smtp_message)
    ...
    print(" Facebook/Instagram Token Verification Result:")
    print("=" * 50)
    print(message)
    ...
    print(" LinkedIn Token Verification Result:")
    print("=" * 50)
    ...
    print(" YouTube Client Credential Verification Result:")
    print("=" * 50)
    print(yt_client_message)
